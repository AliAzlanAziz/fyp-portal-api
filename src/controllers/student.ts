...
export const postSelectAdvisor = (req: Request, res: Response, next: NextFunction) => {
...
export const getAllAdvisorsRequest = (req: Request, res: Response, next: NextFunction) => {
    return AllAdvisorsRequest(req.query.acceptance_status as string, req.context, res);
}

export const getAdvisorRequest = (req: Request, res: Response, next: NextFunction) => {
    return AdvisorRequest(req.params.id as string, res);
}

export const postSubmitAdvisorForm = (req: Request, res: Response, next: NextFunction) => {
